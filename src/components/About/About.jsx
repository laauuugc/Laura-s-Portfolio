    ...
    <section className={styles.container} id="about">
        ...
        <div className={styles.content}>
          ...
          { icon: "about/serverIcon.png", title: "Chapter 2", 
            text: "Despite the accent, colours and illustrations, I promise I'm serious. I've held jobs at different companies as well as being self-employed. At the same time, I've created several projects and participated in hackathons." },
